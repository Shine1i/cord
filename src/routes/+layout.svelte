	...
	<Toaster bind:this={toaster}>
		...
		<div aria-live="assertive" class="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6">
			<div class="flex w-full flex-col items-center space-y-4 sm:items-end">
				...
				<div class="pointer-events-auto {settings.active ===true ? 'toastEnter' : 'toastLeave'} w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
					<div class="p-4">
						<div class="flex items-start">
							...
							<div class="ml-3 w-0 flex-1 pt-0.5">
								<p class="text-sm font-medium text-gray-900">{settings.title}</p>
