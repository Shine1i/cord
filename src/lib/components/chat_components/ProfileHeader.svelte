...
<div class="bg-gray-500/25 rounded-lg px-4 py-4">
	<div class="flex space-x-3 items-center">
		...
		<div class="min-w-0 flex-1 flex flex-col justify-between">
			<div class="text-sm font-semibold text-slate-900 flex justify-between">
				<div>
					<span class="text-slate-200 group-hover:text-black">Vynxc</span>
					<div class="text-sm text-slate-400 group-hover:text-slate-600">
						<p class="truncate text-ellipsis overflow-hidden font-normal">Online</p>
					</div>
				</div>
				<ul class="flex gap-4 items-center">
					<li>
						<button onclick={startCall} class="group">
							<svg
