		...
		<div class="bg-slate-500/25 px-6 py-12 shadow sm:rounded-lg sm:px-12">
			<form class="space-y-6" action="#" method="POST">
				...
				{#if register}
					<div>
						<label for="Cpassword"
									 class="block text-sm font-medium leading-6 text-white">Confirm
							Password</label>
						<div class="mt-2">
				...
				<div>
					<button type="submit"
						...
						{register === false ? "Sign in" : 'Register'}
					</button>
				</div>
			</form>
			...
			<div>
				<div class="relative mt-10">
					...
					<div
						...
						<span
							class="bg-slate-300 rounded-md px-6 text-gray-900 ">Or continue with</span>
					</div>
				</div>
