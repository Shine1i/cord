	...
	<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
		<div class="bg-slate-500/25 px-6 py-12 shadow sm:rounded-lg sm:px-12">
			<form class="space-y-6" onsubmit={login}>
				...
				{#if register}
					<div>
						<label for="Cpassword" class="block text-sm font-medium leading-6 text-white"
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						<input
							...
							name="remember-me"
							type="checkbox"
							class="h-4 checked:hover:bg-slate-300 rounded border-gray-300 bg-gray-500/25 checked:bg-slate-400 hover:bg-slate-400
					focus-within:checked:bg-slate-400
						focus:ring-slate-600"
						/>
						<label for="remember-me" class="ml-3 block text-sm leading-6 text-slate-200"
							>Remember me</label
						>
					</div>
			...
			<div>
				<div class="relative mt-10">
					...
					<div class="relative flex justify-center text-sm font-medium leading-6">
						<span class="bg-slate-300 rounded-md px-6 text-gray-900">Or continue with</span>
					</div>
				</div>
